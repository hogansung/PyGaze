...
class pygaze_drift_correct(item):
	...
	description = 'Perform eye-tracker drift correction'
	...
	def reset(self):
		...
		self.var.xpos = 0
		self.var.ypos = 0
		self.var.fixation_triggered = 'no'
		self.var.target_color = '[foreground]'
		self.var.target_style = 'default'
		self.var.draw_target = 'yes'
...
class qtpygaze_drift_correct(pygaze_drift_correct, qtautoplugin):
	...
	def custom_interactions(self):
		...
		draw_target = self.var.draw_target == 'yes'
